 ...
 */
public class ConfluentStreamingSourceStateStoreTest extends ConfluentStreamingTestBase {
  ...
  public void setUp() {
    ...
    topic = ConfluentStreamingSourceStateStoreTest.class.getSimpleName() + "_" + testName.getMethodName();
